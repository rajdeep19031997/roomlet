                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 order-lg-0">
                        ...
                        <!-- Name -->
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-3">
                                    <select name="type" class="form-control">
                                        <option <?=($user->type == 'Father')?'selected':''?> value="Father">Father</option>
                                        <option <?=($user->type == 'Mother')?'selected':''?> value="Mother">Mother</option>
                                        <option <?=($user->type == 'Garegin’s')?'selected':''?> value="Garegin’s">Garegin’s</option>
                                    </select>
                                </div>
                                <div class="col-md-9">
                                  <input type="text" class="form-control" required value="{{ old('otherName') ?? $user->otherName }}" name="otherName" id="otherName" required value="">
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="last_name">Address as per adhaar card</label>
                              <textarea name="address" class="form-control" required>{{ old('address') ?? $user->address }}</textarea>
                            </div>
                            <div class="form-group">
                              <label for="last_name">Adhaar Card No</label>
                               <input type="number" class="form-control" name="adhaarNo" value="{{ old('adhaarNo') ?? $user->adhaarNo }}" id="adhaarNo" required value="">
                            </div>
                            <div class="form-group">
                              <label for="last_name">Upload Adhaar Card</label>
                                <div class="row">
                                  <div class="col-md-8">
                                      <input type="file" class="form-control" name="adhaarImage" id="adhaarImage" value="">
                                  </div>
                                  <div class="col-md-4">
                                      @if($user->adhaarImage)
                                        <img src="{{asset($user->adhaarImage)}}" width="50px">
                                      @endif
                                  </div>
                                </div>
                            ...
                            <div class="form-group">
                              <label for="last_name">Member details : </label>
                              <div class="row">
                                
                                <div class="col-md-3">
                                    <label for="last_name">Child Quantity</label>
                                    <input type="number" class="form-control" name="childQuantity" value="{{ old('childQuantity') ?? $user->childQuantity }}" id="childQuantity" required value="">
                                </div>
                                <div class="col-md-9">
                                  <label for="last_name">Other Members</label>
                                  <input type="number" class="form-control" name="otherMembers" value="{{ old('otherMembers') ?? $user->otherMembers }}" id="otherMembers" required value="">
                                </div>
                              </div>
                            </div>
                            <div class="form-group">
                              <label for="last_name">Upload Signature</label>
                              <div class="row">
                                  <div class="col-md-8">
                                      <input type="file" class="form-control" name="signatureImage" id="signatureImage" value="">
                                  </div>
                                   <div class="col-md-4">
                                      @if($user->signatureImage)
                                        <img src="{{asset($user->signatureImage)}}" width="50px">
                                      @endif
                                  </div>
                              </div>
                            </div>
