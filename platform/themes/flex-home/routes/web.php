...
Route::group(['namespace' => 'Theme\FlexHome\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::get('cities', 'FlexHomeController@location')->name('public.location.cities');
...
Route::group(['namespace' => 'Theme\FlexHome\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    Route::group(apply_filters(BASE_FILTER_GROUP_PUBLIC_ROUTE, []), function () {
        ...
        Route::post('/getState','FlexHomeController@getState')->name('getState');
        Route::post('/getCity','FlexHomeController@getCity')->name('getCity');
        Route::post('/user','PropertyController@visit')->name('user');
        Route::post('/feedback','FlexHomeController@feedback')->name('feedback');
        Route::post('/bookNow','FlexHomeController@bookProperty')->name('rent.payment');
        // Route::get('/icon','FlexHomeController@icon')->name('icon');
