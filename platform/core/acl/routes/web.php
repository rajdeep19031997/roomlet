...
use Botble\ACL\Http\Controllers\RoleController;
use Botble\ACL\Http\Controllers\FeedbackController;
...
Route::group(['namespace' => 'Botble\ACL\Http\Controllers', 'middleware' => ['web', 'core']], function () {
    ...
    Route::group(['prefix' => BaseHelper::getAdminPrefix(), 'middleware' => 'auth'], function () {
        ...
        Route::group(['prefix' => 'system'], function () {
            ...
            Route::group(['prefix' => 'roles', 'as' => 'roles.'], function () {
                ...
                // Route::get('/admin/roles/feed', function () {
    ...
    Route::get('admin-theme/{theme}', [UserController::class, 'getTheme'])->name('admin.theme');
     // Route::get('feed','RoleController@adminFeedback')->name('feed');
      // Route::get('feed',[UserController::class, 'adminFeedback'])->name('admin.feed');
    ...
    //     })->name('admin.feed');
    Route::get('/admin/user', [FeedbackController::class, 'feedbackdetails']);
